...
public class ProductController {
	...
	public ModelAndView registByExcel(HttpServletRequest request, MultipartFile excel) {
		...
		// 업로드된 엑셀을 대상으로 해석한다.
		productService.registByExcel(savedFile, context.getRealPath("/resources/shop/img/product"),
	...
	public ModelAndView delete(Product product, HttpServletRequest request) {
		ModelAndView mav = new ModelAndView("redirect:/admin/product/list");
		
		String dest = request.getServletContext().getRealPath("/resources/data/" + product.getProduct_id());
